...
public:
virtual std::shared_ptr<Object> apply(std::shared_ptr<Object> __this__ = nullptr, std::shared_ptr<Object> j = nullptr) {
objBind(brackets(__this__, "name"), j);
std::shared_ptr<Object> __IR_variable1 = std::make_shared<Object>();
objBind(__IR_variable1, objAdd((std::string)"o", j));
renewScope(this, __IR_variable1, "__IR_variable1");
objBind(brackets(__this__, "obj"), __IR_variable1);
return std::make_shared<Object>();
}

virtual std::shared_ptr<Object> newObj(std::shared_ptr<Object> j) {
std::shared_ptr<Object> ret = std::make_shared<Object>();
ret->tag = "disc";
if(this->prototype.first == nullptr) {
this->prototype.first = std::make_shared<Object>();
...
std::shared_ptr<Object> t = std::make_shared<Object>();
renewScope(this, t, "t");
objBind(t, (std::string)"i");
renewScope(this, t, "t", false);
std::shared_ptr<Object> b = std::make_shared<Object>();
renewScope(this, b, "b");
objBind(b, a->newObj(t));
renewScope(this, b, "b", false);
API["console.log"](b);
std::shared_ptr<Object> i = std::make_shared<Object>();
renewScope(this, i, "i");
objBind(i, (double)1);
renewScope(this, i, "i", false);
while(({
std::shared_ptr<Object> __IR_variable2 = std::make_shared<Object>();
objBind(__IR_variable2, objIsSmaller(i, (double)5));
renewScope(this, __IR_variable2, "__IR_variable2");
objIsEqual(__IR_variable2, true);
})) {
API["console.log"](i);
std::shared_ptr<Object> __IR_variable3 = std::make_shared<Object>();
objBind(__IR_variable3, objAdd(i, (double)1));
renewScope(this, __IR_variable3, "__IR_variable3");
objBind(i, __IR_variable3);
renewScope(this, i, "i", false);
};
return nullptr;
}
