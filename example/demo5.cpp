...
objBind(__IR_variable1, objAdd(objFetch(this, "global", 2), (double)1));
renewScope(this, __IR_variable1, "__IR_variable1");
objBind(objFetch(this, "global", 2), __IR_variable1);
renewScope(this, objFetch(this, "global",  2), "global", false,  2);
return std::make_shared<Object>();
}

virtual std::shared_ptr<Object> newObj(std::shared_ptr<Object> e) {
std::shared_ptr<Object> ret = std::make_shared<Object>();
ret->tag = "disc";
if(this->prototype.first == nullptr) {
this->prototype.first = std::make_shared<Object>();
...
std::shared_ptr<Object> global = std::make_shared<Object>();
renewScope(this, global, "global");
objBind(global, (double)0);
renewScope(this, global, "global", false);
std::shared_ptr<Object> a = std::make_shared<Object>();
renewScope(this, a, "a");
objBind(a, newFunc<__IRFUNC1>(1));
renewScope(this, a, "a", false);
std::shared_ptr<Object> dummy = std::make_shared<Object>();
renewScope(this, dummy, "dummy");
objBind(dummy, std::make_shared<Object>());
renewScope(this, dummy, "dummy", false);
std::shared_ptr<Object> add = std::make_shared<Object>();
renewScope(this, add, "add");
std::shared_ptr<Object> __IR_variable2 = std::make_shared<Object>();
objBind(__IR_variable2, objFetch(this, "a", 0)->apply(objFetch(this, "a", 0), objFetch(this, "dummy", 0)));
renewScope(this, __IR_variable2, "__IR_variable2");
objBind(add, __IR_variable2);
renewScope(this, add, "add", false);
objFetch(this, "add", 0)->apply(objFetch(this, "add", 0), objFetch(this, "dummy", 0));
API["console.log"](objFetch(this, "global", 0));
return nullptr;
}
};
