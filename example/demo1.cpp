...
public:
	...
	boost::any value;
	std::stack<std::map<std::string, std::shared_ptr<Object>>> recurscope;
	Object() = default;
	~Object() = default;
...
std::shared_ptr<Object> c = std::make_shared<Object>();
renewScope(this, c, "c");
...
objBind(brackets(__IR_variable1, "name"), (std::string)"John");
objBind(brackets(__IR_variable1, "age"), (double)5);
objBind(c, __IR_variable1);
renewScope(this, c, "c", false);
...
objBind(__IR_variable2, a->apply(a));
renewScope(this, __IR_variable2, "__IR_variable2");
API["console.log"](__IR_variable2);
return nullptr;
}
};
