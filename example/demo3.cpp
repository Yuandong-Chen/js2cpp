...
objBind(Person, newFunc<__IRFUNC1>(1));
renewScope(this, Person, "Person", false);
std::shared_ptr<Object> name = std::make_shared<Object>();
renewScope(this, name, "name");
objBind(name, (std::string)"John");
renewScope(this, name, "name", false);
std::shared_ptr<Object> john = std::make_shared<Object>();
renewScope(this, john, "john");
objBind(john, Person->newObj(name));
...
objBind(a, __IR_variable1);
renewScope(this, a, "a", false);
objBind(brackets(a, "proto"), john);
std::shared_ptr<Object> __IR_variable2 = std::make_shared<Object>();
objBind(__IR_variable2, brackets(a, "name"));
